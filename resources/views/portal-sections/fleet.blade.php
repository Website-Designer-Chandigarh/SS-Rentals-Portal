<div>
    <div class="tabs"><button type="button" class="tab {{ $fleetTab === 'trucks' ? 'active' : '' }}" wire:click="$set('fleetTab','trucks')">Trucks</button><button type="button" class="tab {{ $fleetTab === 'trailers' ? 'active' : '' }}" wire:click="$set('fleetTab','trailers')">Trailers</button><button type="button" class="btn btn-primary btn-sm" style="margin-left:auto" wire:click="openModal('vehicle')">Add Vehicle</button></div>
